...
export default Component.extend({
  ...
  wrapperClass: computed(
    ...
    'outOfBounds',
    function () {
      const informsDocumentStatus = get(this, 'field.informs_document_status');
      const outOfBounds = get(this, 'outOfBounds');
  ...
  outOfBounds: computed(
    ...
    function () {
      ...
      const lowerControlLimit = parseFloat(get(this, 'field.lower_control_limit'));
      const upperControlLimit = parseFloat(get(this, 'field.upper_control_limit'));
