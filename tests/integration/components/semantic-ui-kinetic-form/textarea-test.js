...
module('Integration | Component | semantic ui kinetic form/textarea', function(hooks) {
  ...
  test('displays field.title', async function(assert) {
    ...
    await render(hbs`{{semantic-ui-kinetic-form/textarea field=testField update=(action updateSpy)}}`);
  ...
  test('shows the current value', async function(assert) {
    await render(hbs`{{semantic-ui-kinetic-form/textarea value="test-value" update=(action updateSpy)}}`);
  ...
  test('calls update action when user enters text', async function() {
    await render(hbs`{{semantic-ui-kinetic-form/textarea update=(action updateSpy)}}`);
  ...
  test('highlights as an error when error is truthy', async function(assert) {
    ...
    await render(hbs`{{semantic-ui-kinetic-form/textarea error=testError update=(action updateSpy)}}`);
