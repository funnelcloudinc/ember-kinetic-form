...
module('Integration | Component | semantic ui kinetic form/select', function(hooks) {
  ...
  test('displays field.title', async function(assert) {
    ...
    await render(hbs`{{semantic-ui-kinetic-form/select field=this.testField update=(action this.updateSpy)}}`);
  ...
  test('shows the current value', async function(assert) {
    ...
    await render(
      hbs`{{semantic-ui-kinetic-form/select value="test-value" field=this.testField update=(action this.updateSpy)}}`
    );
  ...
  test('highlights as an error when error is truthy', async function(assert) {
    ...
    await render(hbs`{{semantic-ui-kinetic-form/select field=this.testField error=this.testError update=(action this.updateSpy)}}`);
