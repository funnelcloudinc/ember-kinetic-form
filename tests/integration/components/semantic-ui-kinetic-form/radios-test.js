...
module('Integration | Component | semantic ui kinetic form/radios', function(hooks) {
  ...
  test('displays field.title', async function(assert) {
    ...
    await render(hbs`{{semantic-ui-kinetic-form/radios field=testField update=(action updateSpy)}}`);
  ...
  test('shows the current value', async function(assert) {
    ...
    await render(hbs`{{semantic-ui-kinetic-form/radios value=testValue update=(action updateSpy)}}`);
  ...
  test('highlights as an error when error is truthy', async function(assert) {
    ...
    await render(hbs`{{semantic-ui-kinetic-form/radios error=testError update=(action updateSpy)}}`);
