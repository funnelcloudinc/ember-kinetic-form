...
module(
  ...
  function (hooks) {
    ...
    test('displays section items', async function (assert) {
      ...
      await render(hbs`{{semantic-ui-kinetic-form/section field=this.testField update=this.noop}}`);
    ...
    test('displays sub-sections', async function (assert) {
      ...
      set(this, 'noop', function() {})
      await render(hbs`<div id="test-parent">{{semantic-ui-kinetic-form/section field=this.testField update=this.noop}}</div>`);
