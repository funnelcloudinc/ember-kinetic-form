...
module('Integration | Component | kinetic form/radios', function(hooks) {
  ...
  test('displays field.title', async function(assert) {
    ...
    await render(hbs`{{kinetic-form/radios field=this.testField update=(action this.updateSpy)}}`);
  ...
  test('shows the current value', async function(assert) {
    ...
    await render(hbs`{{kinetic-form/radios value=this.testValue update=(action this.updateSpy)}}`);
  ...
  test('highlights as an error when error is truthy', async function(assert) {
    ...
    await render(hbs`{{kinetic-form/radios error=this.testError update=(action this.updateSpy)}}`);
