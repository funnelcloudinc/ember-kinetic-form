...
module('Integration | Component | kinetic form/string', function(hooks) {
  ...
  test('displays field.title', async function(assert) {
    ...
    await render(hbs`{{kinetic-form/string field=this.testField update=(action this.updateSpy)}}`);
  ...
  test('shows the current value', async function(assert) {
    await render(hbs`{{kinetic-form/string value="test-value" update=(action this.updateSpy)}}`);
  ...
  test('highlights as an error when error is truthy', async function(assert) {
    ...
    await render(hbs`{{kinetic-form/string error=this.testError update=(action this.updateSpy)}}`);
