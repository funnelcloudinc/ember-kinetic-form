...
test('displays field.title', function(assert) {
  ...
  this.render(hbs`{{kinetic-form/select field=testField update=(action updateSpy)}}`);
...
test('shows the current value', function(assert) {
  ...
  this.render(hbs`{{kinetic-form/select value="test-value" field=testField update=(action updateSpy)}}`);
...
test('highlights as an error when error is truthy', function(assert) {
  ...
  this.render(hbs`{{kinetic-form/select error=testError update=(action updateSpy)}}`);
